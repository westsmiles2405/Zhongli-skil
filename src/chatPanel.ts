...
import { ZhongliStats } from './stats';
...
export class ZhongliChatPanel implements vscode.WebviewViewProvider {
    public static readonly viewType = 'zhongli.chatPanel';
    private view?: vscode.WebviewView;
    private messages: PendingMessage[] = [];
    private onUserMessage?: (text: string) => void;
    private latestStats?: ZhongliStats;
    ...
    public updateStats(stats: ZhongliStats): void {
